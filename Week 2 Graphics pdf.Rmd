---
title: 'GRAPHICS AND EXPLORATORY ANALYSIS'
...
#axis, will be Per capita crime rate. So we are specfying we are using the "crim" 
...
pairs(Boston_SM, pch=".", #Produces smaller points to make it easier to see
      upper.panel=panel.smooth, #Adds for smoothed lines to be added 
      lower.panel=panel.cor, #Ask for correlation coeffients in the upper panel 
...
#guides in this case removes the title of the legent (bcsvictim), 
