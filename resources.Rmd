...
+ [Kaplan  2012 Statistical modeling: A fresh approach](http://www.mosaic-web.org/go/StatisticalModeling/). This is not written for social science students. Yet it represents an interesting take on trying to introduce statistics. Better at the foundational stuff than Field. The focus is on teaching statistical reasoning rather than R. But it is a product linked to the mosaic project, funded by the National Science Foundation, and like the previous book aims to introduce R via minimal coding using the `mosaic` package. I very much like some aspected of the teaching philosophy underpinning this project. 

Finally, they are not books stricto sensu but [Quick R](http://www.statmethods.net/) and the [R Cookbook](http://www.cookbook-r.com/) are possibly the pages you will visit the most as you try to figure out how to to things with R.

###Video lecture series

There are two in particular worth keeping an eye on. They can be used as part of a blended learning experience.

+ [Mike Marin series of videos](https://www.youtube.com/playlist?list=PLqzoL9-eJTNATicffatWXTEjwMq6N0Sf3) This is really good for something done outside a MOOC. The production values are very good. And a lot of effort has been put into it. Mike lectures at the School of Population and Public Health at the University of British Columbia. Highly recommended.

+ [Elementary Statistics with R](https://www.youtube.com/user/GCstats). This is a full video lecture course on elementary statistics that was created and developed at Georgetown College in Kentucy. They also use the `mosaic` package as part of this course. I have not seen the whole series of videos, but the ones I have are pretty decent. I use them (combined with other materials) for my teaching as part of the flipped classroom experience.
...
+ [datacamp](https://www.datacamp.com/) has adapted this technology to develop a series of online interactive tutorials. Basically you will be interacting the R via the web. But the principles are the same. At the moment they have three different courses. This is linked to [OpenIntro](http://www.openintro.org/stat/labs.php?stat_book=os), which also allow you to go through the foundational course using swirl in your local machine. 

+ [Try R](http://tryr.codeschool.com/) O'Reilly also have a free interactive code. More focused on the programming side of things than the statistics, but worth a try (no pun intented).
