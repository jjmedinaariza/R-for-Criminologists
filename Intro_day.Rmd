...
###The r script and data view window are where you write your code and where you can view your data
...
Finally you can click on the packages tab to see what packages are already in your environment, and you can add or detach packages using this tab. We'll talk more about packages later.
